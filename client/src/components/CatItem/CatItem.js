...
const CatItem = ({src, srcBack, alt, name, description, chippedInfo, id, trash, select, gender, age,}) => {
    ...
    return (
        ...
        >
            <li key={id} onClick={handleClick}>
                <CSSTransition in={isCardRotate} timeout={500} classNames="front-flip">
                ...
                <CSSTransition in={!isCardRotate} timeout={500} classNames="back-flip">
